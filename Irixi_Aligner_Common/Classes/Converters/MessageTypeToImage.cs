        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (state)
            {
                ...
                case MessageType.Good:
                    image = new BitmapImage(new Uri("pack://application:,,,/right.png"));
                    break;

                case MessageType.Warning:
                    image = new BitmapImage(new Uri("pack://application:,,,/warning_32x32.png"));
                    break;

                case MessageType.Error:
                    image = new BitmapImage(new Uri("pack://application:,,,/wrong.png"));
                    break;
            }
            return image;
        }
